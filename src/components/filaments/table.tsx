...
import { Edit, MoreVertical, RefreshCw, Trash2, CheckCircle } from "lucide-react"
...
export default function FilamentTable({ filaments, onEdit, onDelete, onMarkAsFinished, onRestock }: Props) {
  return (
    ...
    <Table>
      ...
      <TableBody>
        {filaments.map((filament) => (
          <TableRow key={filament.id} className={filament.status === "finished" ? "opacity-70 bg-muted/20" : ""}>
            ...
            <TableCell>
                    <Badge variant={filament.status === "available" ? "default" : "secondary"}>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        {filament.status === "available" ? (
                          <DropdownMenuItem onClick={() => onMarkAsFinished(filament.id)}>
